...
* SEIMS Documentations
  * Online versions
    * [English (powered by Doxygen)](https://crazyzlj.github.io/SEIMS_doc), [English without API references (powered by Gitbook)](https://crazyzlj.gitbooks.io/seims_doc_test/content/en/)
    * [简体中文（由Doxygen驱动）](https://crazyzlj.github.io/SEIMS_doc/zh-cn), [简体中文，不含 API 参考手册（由Gitbook驱动）](https://crazyzlj.gitbooks.io/seims_doc_test/content/zh-cn/)
  * Download PDF versions without API references (powered by [Gitbook](https://legacy.gitbook.com/))
    * [English](https://legacy.gitbook.com/download/pdf/book/crazyzlj/seims_doc_test?lang=en)
    * [简体中文](https://legacy.gitbook.com/download/pdf/book/crazyzlj/seims_doc_test?lang=zh-cn)
